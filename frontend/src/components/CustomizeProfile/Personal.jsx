...
function Personal({refetchUser}){
    ...
    const handleSubmit=async(e)=>{
        try{
            ...
            toast.error(error?.data?.message || "failed to updated account details");
        }
    }
    return (
                ...
                <form onSubmit={handleSubmit}>
                    <div className="rounded-lg border">
                        ...
                        <div className="flex items-center justify-end gap-4 p-4">
                            <button type="submit" className="inline-block bg-[#08e6f5] px-3 py-1.5 text-black">Save Changes</button>
                        </div>
                    </div>
                </form>
            </div>
